...
| 0.82–0.94 | 人物从首页左侧摔入、撑起、站稳 | 人、狗 | 保留同一运动方向和姿态连续性 |
| 0.94–1.00 | 小狗在人物脚边原地停下 | 人、狗、身份区 | 人物扶帽或整理衣服；小狗不得绕人物移动 |
...
- 首页身份文字稳定显示；
- 舞台可以解除固定并进入后续内容。
- 当前 A1 的人物和小狗完全静止，不保留 idle loop；头部随指针属于待设计交互，素材方案确认前不得用整角色视差冒充。
