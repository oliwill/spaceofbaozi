...
> 版本：1.0  
> 状态：执行中，当前阶段 CP2（CP1 已于 D-122 批准）
> 项目负责人 / 最终批准：包子  
...
| 角色生成 | Seedance 2.5 只生成纯色键背景上的语义动作 |
...
| 新角色动作 Pilot | 待执行 | CP2：包子按批准 Prompt 生成，人物先行，每角色首轮最多 3 条候选 |
...
- 每个角色第一轮最多生成 3 条候选，不生成整屏版本。
- 嘉乐只做“朝右原地奔跑”，人物只做“被向右拉拽—失衡—向右摔倒”。
- 记录模型版本、日期、Prompt 版本、参考图、任务 ID 和淘汰原因。
- 先审人物 Pilot，因为人物动作是最大风险；人物通过后再批准嘉乐批量生成。

### 交付物

- `review/person-pilot-01..03.mp4`
- `review/jiale-pilot-01..03.mp4`
- `review/generation-log.md`
- `review/pilot-scorecard.md`

### 出口门禁

- 人物和嘉乐身份稳定，无多余肢体、变脸、衣服变化或尾巴复制。
- 纯色键背景均匀，无草地、阴影地面、文字和相机运动。
- 人物运动始终为侧向向右，没有扑向镜头的透视。
- 动作中间帧足够连续，可以进入插帧和透明化处理。

### 停止条件

两轮、最多 6 条人物 Pilot 仍无法保持身份或正确摔倒方向时停止 Seedance 扩量，重新设计人物动作关键帧，不把错误素材交给 Harness 修补。
